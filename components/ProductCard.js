    ...
    return (
        ...
        <div className="rounded overflow-hidden shadow-lg">
            ...
            <div className="px-6 pt-4 pb-2">
                ...
                <br />
                <div className='mt-5'>
                    <Link href={'/product/[id]'} as={`/product/${_id}`} className="inline-block bg-gray-200 rounded-full px-3 py-1 text-lg font-semibold w-full text-center text-gray-700 hover:bg-yellow-200 mx-auto mb-2">View details</Link>
                </div>
            </div>
        </div>
